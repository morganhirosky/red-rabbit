      ...
      subsections: [
        {
          ...
          paragraphs: [
            "After an hour's drive into what felt like a more pastoral stretch of North Austin, I arrived at what I initially assumed was the wrong place. I had turned off I-35 into a rural-leaning neighborhood, the kind of in-between space where autobody shops sit beside oddly spaced single-family homes, neither fully urban nor fully country.",
            "I pulled into a fence-lined parking lot that only qualified as a parking lot because it was filled with vehicles; otherwise, it was really just a well-kept stretch of grass. But what stood out most was not the cars — it was the boats. Nearly as many motorboats as vehicles sat scattered across the lawn, large and small sailboats without sails, all resting on trailers connected to nothing, as if temporarily placed and then forgotten in their arrangement.",
            "The cluster of cars and boats sat outside of a house. I parked on the grass with my back to the building and tried to confirm I was actually in the right place. That uncertainty was interrupted by the easy smiles of two older men about fifty paces away, working on one of the beached boats, unbothered by my arrival.",
            "When I turned back toward the house, I noticed a small shed to my left with the name \"Morgan\" painted on it — my name. I liked the coincidence more than I probably should have. It was insignificant, but details like that have a way of feeling intentional, as if the world occasionally leaves behind small markers to suggest direction. I've always been prone to reading meaning into things that may not hold any, but I was glad I noticed it nonetheless.",
            "As I made my way toward the house, I encountered my first clear confirmation that I was in the right place: a boy who couldn't have been older than 18 was pushing a gurney. On it was a zipped body bag, holding the unmistakable shape of a human body still inside. He was preparing to load it into the open trunk of a black Suburban.",
            "I gave an awkward wave. \"Hi, I'm here to see Ms. Adeline.\"",
            "He paused, looked at me briefly, and said, \"Oh. Okay.\" Then he left what he was doing to show me inside.",
            "I followed him up the front porch steps and into the house. He disappeared into a room on the right. The interior opened up quickly — gray vinyl flooring, gray walls, and desks spaced every few feet to the left. Directly ahead sat a large fish tank, so oversized it functioned less as décor and more as a divider between spaces.",
            "Beyond it, I could see into a kitchen being used as an actual kitchen. To the right of that, a living room area held a matching armchair and sofa, angled around a small side table tucked into the corner between them. Against the wall stood a tall, narrow glass display case containing a folded American flag and a military portrait of an older man in uniform.",
            "Ms. Adeline emerged smiling from the same room the boy had disappeared into. We shook hands, exchanged brief, enthusiastic greetings, and she led me into what I'll call the living room. I sat on the couch perpendicular to her and asked if she was comfortable with the conversation being recorded. She said of course, and then we began.",
          ],
        },
        {
          title: "After the interview",
          paragraphs: [
            "As we exited the house and stepped into the adjoining warehouse, Mrs. Bui paused briefly and turned toward me.",
            "\"Do you smell that?\"",
            "Before I could fully place it, the air revealed itself — a faint, sweet floral scent, unexpectedly soft against the industrial setting. It lingered in a way that didn't quite match the space.",
            "\"Yes, I do,\" I replied. \"It smells very floral, like flowers.\"",
            "Mrs. Bui seemed pleased with the answer, almost affirmed by it, and offered an explanation that reframed the smell entirely.",
            "\"That's what everyone says! That's what human death smells like. So interesting that it's so commonly described that way.\"",
            "The warehouse itself was split between the practical and the clinical. To the left sat two cremation ovens, unassuming in their industrial design. Directly ahead were roll-out drawer fridges aligned like heavy cabinetry. To the right, a thick metal door led into another room, where Mrs. Bui motioned for me to follow her if I wanted to observe the embalming process.",
            "As I stepped inside, my eyes began to sting almost immediately, watering in a way that felt involuntary. I had never seen a cadaver before. The curiosity that brought me there was still intact, but seeing three bodies at once created a kind of cognitive overwhelm that curiosity alone didn't fully prepare me for. It wasn't enough to bring me to tears, but it was enough to make me aware of my own reaction in a way I wasn't expecting.",
            "I assured Mrs. Bui I wasn't crying. She laughed and explained that the formaldehyde used in the embalming process was a powerful chemical that filled the air and often caused that reaction.",
            "Around us, the morticians worked with quiet precision, explaining elements of the embalming process as they went. Their explanations came in technical layers — procedural, clinical, routine — but I found myself increasingly detached from the present moment. It was difficult to look directly at the bodies, but equally difficult not to. Later, I found that many of the specifics they described had blurred together, the details slipping away in hindsight.",
            "At one point, Adeline insisted I touch one. I declined and shook my head. She gently took my hand anyway and guided my finger to graze the stubble on the deceased gentleman's left cheek. His skin was cold from the refrigeration, like all the others. There was no warmth, no color — the usual pink tones replaced by a muted, bruised appearance that came from the absence of circulation and elasticity.",
            "They appeared full in a way that was unfamiliar, shaped and firm in contrast to what one might expect, a result of the chemicals and the physical effects of rigor mortis. The room itself was spotless, maintained with the same precision as a surgical space, and the morticians wore attire that echoed that comparison — clean, controlled, clinical.",
            "In total, the tour offered a direct look into the technical and legal processes that surround after-death care, a system that exists largely out of view. The experience left me slightly jarred, though not ungrateful. If anything, it clarified how structured and procedural an unseen part of society can be — even in the moments most people rarely, if ever, witness.",
          ],
        },
      ],
    },
