  ...
  "03": [
    {
      ...
      paragraphs: [
        "My project concept was dedicated to exploring different morticians' views on life, death, birth, religion, spirituality, family, and joy. However, my personal curiosity extended past existentialism into much simpler realms.",
        "I consider embalming to be closely related to a doctor performing a gruesome surgery. They both see things most people never will, and require the ability to either stomach their feelings or grow desensitized enough to participate in their own lives and attend their kid's piano recital that evening. I just assume it's harder because the doctor's patient wakes up (hopefully), and the mortician's client never will. The burden is death and while the doctor fights to avoid it, the mortician wakes up to confront it, on call 24-hours a day, seven days a week.",
        "My curiosity started a couple years ago at a graduation party for one of my old friends. His aunt Sandra attended and I knew she had been married to a mortician — more so, recently divorced from one. She and I were sitting together in his backyard when I began asking questions. I think she knew her experience was fascinating, so she was very open.",
        "She told me her husband embalmed her father and she watched. She looked far away as she said it, but maybe that's just something I put on her in the moment. I asked how it made her feel or if it affected her in any way — she said the grief was already strange enough so it didn't add to her foreign feelings, but that maybe in hindsight, she wouldn't do it again. I don't think I believed the first bit.",
        "Since that moment, I've thought about how something like that affects someone — how it truly affected her, and how it affected her husband. Is there psychology behind it? Did it play into their divorce? Naturally, this led me to think of morticians as a whole. I wanted to know how everyday regularities are impacted; does it change how they feel when the sun rises each day? Does the proximity dull the intensity of happy moments, simple pleasures, the passings of their own loved ones? Or does it amplify it?",
      ],
    },
    {
      title: "Jimmy",
